  ...
  const projects: TProjects[] = [
    {
      image: fitness,
      title: "Fitness App",
      summary: `I worked on this Fitness App with a team using Agile methodology. Built with React, it features workout sections, meal plans for three levels, muscle-based workout browsing, and instructional videos.`,
      tools:
